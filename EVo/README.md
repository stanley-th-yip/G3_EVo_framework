...
* Optional estimation of OCS production at the final pressure step
...
To get a version of this code on your machine, please follow the the instructions for forking here:
https://help.github.com/en/github/getting-started-with-github/fork-a-repo 

### Prerequisites

This programme requires Python 3 to run. It also requires a specific version of several packages; the best way to do this if you already have
python installed on your computer is to install a virtual environment within which you can run the code. You can do this two ways; either using the virtualenv package for python, or by using Anaconda and using a conda environment.

#### Python virtualenv

If you don't already have the virtual environment package on your computer, open a terminal and run
```
pip3 install virtualenv
```
Then, when you are inside the EVo file,
```
python3 -m venv evo_venv
```
To activate the environment on WSL/linux/Mac:
```
source evo_venv/bin/activate
```
Windows:
```
source evo_venv\Scripts\activate.bat
```
Then run
```
pip3 install -r Data/requirements.txt
```
This creates a virtual environment called 'evo_venv', opens it and installs all the correct packages necessary to run the model.
If, on Windows particularly, you see errors after running this relating to build wheels, or failing to install GMPY2, run the follwing then attempt installing the requirements file again:
```
pip3 install wheel
sudo apt install libgmp-dev libmpfr-dev libmpc-dev
pip3 install -r Data/requirements.txt
```
Whenever you run EVo, make sure you are within the virtual environment first as it won't work without the correct dependencies!
If you see a Numpy error when trying to run the code, make sure you've activated your environment and installed all the dependencies correctly.

#### Anaconda

Within the anaconda prompt, navigate to the evo directory, then run
```
conda env create -f Data/environment.yml
conda activate evo_env
```
in this case, the environment is named for you as 'evo_venv'

## Running EVo

The model is set up using the env.yaml file. Open the file and edit the parameters to match what you want.

Then inside a terminal and INSIDE THE VIRTUAL ENVIRONMENT:
```
...
|-----------------------------------|-----------------------------------|-------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|
| CALC_PRECISION                    | DEPRECATED - REMOVE               |                                                                                                                               |                                                                                                                           |                                                  |
...
* Gas-only chemistry
* Open-system degassing (This is currently being tested and will be released shortly)
