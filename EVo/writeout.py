...
def writeout_file(sys, gas, melt, P):
    ...
    if sys.run.SINGLE_STEP == False:
        ...
        while i < len(P):
            output.write(f"{P[i]:.1f} \t {cnvt.generate_fo2_buffer(sys, gp.exp(gas.fo2[i]), P[i]):+.3} \t {gp.exp(gas.fo2[i]):.3e} \t {melt.F[i+1]:.3} \t {sys.rho[i]:.3} \t {melt.rho_store[i]:.3} \t {sys.GvF[i] * 100:} \t {sys.WgT[i+1] * 100:.g} \t {gas.M[i]} \t {gas.mH2O[i+1]:.g} \t {gas.mH2[i+1]:.g} \t {gas.mO2[i+1]:.g} \t {gas.mCO2[i+1]:.g} \t {gas.mCO[i+1]:.g} \t {gas.mCH4[i+1]:.g} \t {gas.mSO2[i+1]:.g} \t {gas.mH2S[i+1]:.g} \t {gas.mS2[i+1]:.g} \t {gas.mN2[i+1]:.g} \t {gas.Wt['H2O'][i]:.g} \t {gas.Wt['H2'][i]:.g} \t {gas.Wt['O2'][i]:.g} \t {gas.Wt['CO2'][i]:.g} \t {gas.Wt['CO'][i]:.g} \t {gas.Wt['CH4'][i]:.g} \t {gas.Wt['SO2'][i]:.g} \t {gas.Wt['H2S'][i]:.g} \t {gas.Wt['S2'][i]:.g} \t {gas.Wt['N2'][i]:.g} \t {melt.h2o[i]*100:.g} \t {melt.h2[i]*100:.g} \t {melt.co2[i]*100:.g} \t {melt.co[i]*100:.g} \t {melt.ch4[i]*100:.g} \t {melt.graphite[i]*100:.g} \t {melt.sulfide[i]*100:.g} \t {melt.sulfate[i]*100:.g} \t {melt.s[i]*100:.g} \t {melt.n[i]*100:.g} \t {gas.mCO2[i+1]/gas.mCO[i+1]:.6e} \t {gas.mCO2[i+1]/gas.mH2O[i+1]:.6e} \t {gas.mCO2[i+1]/gas.mSO2[i+1]:.6e} \t {gas.mH2S[i+1]/gas.mSO2[i+1]:.6e} \t {gas.f['H2'][i]:.8g} \t {gas.f['H2O'][i]:.6g} \t {gas.f['CO2'][i]:.6e} \t {gas.f['CO'][i]:.6e} \t {gas.f['CH4'][i]:.6g} \t {gas.f['SO2'][i]:.8g} \t {gas.f['H2S'][i]:.8g} \t {gas.f['S2'][i]:.8g} \t {gas.f['N2'][i]:.8g} \t {cnvt.atomicM_calc(sys, melt, gas, 'h', i)*1000000:.8g} \t {cnvt.atomicM_calc(sys, melt, gas, 'c', i)*1000000:.8g} \t {cnvt.atomicM_calc(sys, melt, gas, 'o', i)*1000000:.8g} \t {cnvt.atomicM_calc(sys, melt, gas, 'o_tot', i)*1000000:.8g} \t {cnvt.atomicM_calc(sys, melt, gas, 's', i)*1000000:.8g} \t {cnvt.atomicM_calc(sys, melt, gas, 'n', i)*1000000:.8g} \n")
            i += 1
    else:
        output.write(
                f"{P[-1]:.1f} \t {cnvt.generate_fo2_buffer(sys, gp.exp(gas.fo2[-1]), P[-1]):+.3} \t {gp.exp(gas.fo2[-1]):.3e} \t {melt.F[-1]:.3} \t {sys.rho[-1]:.3} \t {melt.rho_store[-1]:.3} \t {sys.GvF[-1] * 100} \t {sys.WgT[-1] * 100:.g} \t {gas.M[-1]} \t {gas.mH2O[-1]:.g} \t {gas.mH2[-1]:.g} \t {gas.mO2[-1]:.g} \t {gas.mCO2[-1]:.g} \t {gas.mCO[-1]:.g} \t {gas.mCH4[-1]:.g} \t {gas.mSO2[-1]:.g} \t {gas.mH2S[-1]:.g} \t {gas.mS2[-1]:.g} \t {gas.mN2[-1]:.g} \t {gas.Wt['H2O'][-1]:.g} \t {gas.Wt['H2'][-1]:.g} \t {gas.Wt['O2'][-1]:.g} \t {gas.Wt['CO2'][-1]:.g} \t {gas.Wt['CO'][-1]:.g} \t {gas.Wt['CH4'][-1]:.g} \t {gas.Wt['SO2'][-1]:.g} \t {gas.Wt['H2S'][-1]:.g} \t {gas.Wt['S2'][-1]:.g} \t {gas.Wt['N2'][-1]:.g} \t {melt.h2o[-1]*100:.g} \t {melt.h2[-1]*100:.g} \t {melt.co2[-1]*100:.g} \t {melt.co[-1]*100:.g} \t {melt.ch4[-1]*100:.g} \t {melt.graphite[-1]*100:.g} \t {melt.sulfide[-1]*100:.g} \t {melt.sulfate[-1]*100:.g} \t {melt.s[-1]*100:.g} \t {melt.n[-1]*100:.g} \t {gas.mCO2[-1]/gas.mCO[-1]:.g} \t {gas.mCO2[-1]/gas.mH2O[-1]:.6g} \t {gas.mCO2[-1]/gas.mSO2[-1]:.6g} \t {gas.mH2S[-1]/gas.mSO2[-1]:.6g} \t {gas.f['H2'][-1]:.8g} \t {gas.f['H2O'][-1]:.6g} \t {gas.f['CO2'][-1]:.8g} \t {gas.f['CO'][-1]:.8g} \t {gas.f['CH4'][-1]:.6g} \t {gas.f['SO2'][-1]:.8g} \t {gas.f['H2S'][-1]:.8g} \t {gas.f['S2'][-1]:.8g} \t {gas.f['N2'][-1]:.8g} \t {cnvt.atomicM_calc(sys, melt, gas, 'h', -1, WgT=sys.WgT[-1])*1000000:.8g} \t {cnvt.atomicM_calc(sys, melt, gas, 'c', -1, WgT=sys.WgT[-1])*1000000:.8g} \t {cnvt.atomicM_calc(sys, melt, gas, 'o', -1, WgT=sys.WgT[-1])*1000000:.8g} \t {cnvt.atomicM_calc(sys, melt, gas, 'o_tot', -1, WgT=sys.WgT[-1])*1000000:.8g} \t {cnvt.atomicM_calc(sys, melt, gas, 's', -1, WgT=sys.WgT[-1])*1000000:.8g} \t {cnvt.atomicM_calc(sys, melt, gas, 'n', -1, WgT=sys.WgT[-1])*1000000:.8g} \n")
    output.close()
