...
def kc91_fo2(C,T,P,FO2):  # If fo2 was set
    ...
    F = gp.exp(a*FO2 + b/T + c +
               dal2o3*C['al2o3'] + dfeo*C['feo'] + dcao*C['cao'] + dna2o*C['na2o'] + dk2o*C['k2o'] + e*(1.0 - T0/T - gp.log(T/T0)) + f*P/T + g*(T-T0)*P/T + h*P**2/T)
...
def kc91_fe3(Cm,T,P):  # if the ratio was set
    ...
    FO2 = gp.exp((gp.log(Cm['fe2o3']/Cm['feo']) - b/T - c - dal2o3*Cm['al2o3'] - dfeo*(Cm['feo'] + Cm['fe2o3']*0.8998) - dcao*Cm['cao'] - dna2o*Cm['na2o'] - dk2o*Cm['k2o'] - e*(1.0 - T0/T - gp.log(T/T0)) - f*(P/T) - g*(T-T0)*P/T - h*P**2/T)/a)
...
def r2013_fo2(cm, T, P, lnfo2):
    ...
    F = gp.exp(a * lnfo2 + b / T + c * (Pgpa / T) + d * cm['feo'] + e * cm['al2o3'] + f * cm['cao'] + g * cm['na2o'] + h * cm['k2o'] + i * cm['p2o5'] + j)
